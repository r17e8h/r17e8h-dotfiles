...
export class ExpandableDeviceMenuItem extends PopupSubMenuMenuItem {
    ...
    _ipTitleLabel;
    _ipValueLabel;
    _uploadSpeedTitleLabel;
    _uploadSpeedValueLabel;
    _downloadSpeedTitleLabel;
    _downloadSpeedValueLabel;
    _totalSpeedTitleLabel;
    _totalSpeedValueLabel;
    _totalDataTitleLabel;
    _totalDataValueLabel;
    _lastResetedTitleLabel;
    _lastResetedValueLabel;
    _resetButton;
    ...
    update(device, defaultDeviceName) {
        const { 
        //iconPath,
        name, upSpeed, downSpeed, totalSpeed, totalData, ip, startTime } = device;
